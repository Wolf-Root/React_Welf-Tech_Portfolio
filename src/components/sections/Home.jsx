    ...
    <section id="Home" className="min-h-screen flex items-center justify-center relative">
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-[#38EF7D] to-[#11998E] bg-clip-text text-transparent leading-tight">
            Hi, I'm Youssef
          </h1>

          <p className="text-gray-100 text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
            I'm a Front End developer who loves crafting clean, scalable web applications. My goal is to build solutions that
